...
❖ 𝐏ᴏᴡᴇʀᴇᴅ 𝖡ʏ » [˹ Sᴘɪᴄʏ Bᴏᴛs ˼ 💞](https://t.me/SpicyxBots)**
'''
...
─────────────────────────
❍ ᴄσηᴛᴧᴄᴛ - [˹ Sᴘɪᴄʏ Bᴏᴛs ˼  💞](https://t.me/SpicyxBots)
─────────────────────────**
'''
    HELP_ABOUT = '''
**─────────────────────────
│ ᴡєʟᴄσϻє ᴛσ [˹ Sᴘɪᴄʏ Bᴏᴛs ˼ 💞](https://t.me/SpicyxBots)˼ ʙσᴛ sᴛᴧᴛυs │
─────────────────────────
       ❖ │ ʀєᴧʟ ᴛɪϻє ʙσᴛ's sᴛᴧᴛυs │❖
─────────────────────────
╭⎋ [˹Sᴡᴀɢɢʏ ꭙ Mᴜsɪᴄ˼ ♪](https://t.me/SWAGGY_MUSICBOT) : ᴧʟɪᴠє 
╰⊚ υᴘᴛɪϻє : 12ʜ:58ϻ:20s | ᴄᴘυ : 5.0% | 
       υsᴧɢє : 24 | ᴧssɪsᴛᴧηᴛs : 01
       
╭⎋ [˹ʟᴜsᴛɪғʏ ♪ ᴍᴜsɪᴄ˼](https://t.me/LustifyMusicBot) : ᴧʟɪᴠє 
╰⊚ υᴘᴛɪϻє : 12ʜ:58ϻ:20s | ᴄᴘυ : 5.0% | 
       υsᴧɢє : 24 | ᴧssɪsᴛᴧηᴛs : 01

╭⎋ [˹sᴛꝛɪɴɢ ɢᴇɴᴇꝛᴧᴛσꝛ˼](https://t.me/StringPrimeBot) : ᴧʟɪᴠє 
╰⊚ υᴘᴛɪϻє : 12ʜ:58ϻ:20s | ᴄᴘυ : 5.0% | 
       υsᴧɢє : 24 | ᴧssɪsᴛᴧηᴛs : 01
─────────────────────────
⊚ ʙσᴛ sᴛᴧᴛυs ᴧηᴅ ϻσʀє ʙσᴛs - [ᴄʟɪᴄᴋ ʜєʀє](https://t.me/SpicyxBots/8)
─────────────────────────
⊚ ʟᴧsᴛ ᴄʜєᴄᴋєᴅ ση : ᴅᴧᴛє : 24 ᴅᴇᴄ 2025 
─────────────────────────
❍ 𝐏ᴏᴡєʀєᴅ 𝖡ʏ » [˹ Sᴘɪᴄʏ Bᴏᴛs ˼  💞](https://t.me/SpicyxBots)
─────────────────────────**
'''
    HELP_ALLBOT = '''
**─────────────────────────
